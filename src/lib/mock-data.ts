...
export const MOCK_TIMELINE: TimelineEvent[] = [
  { id: "tl1", year: 1872, title: "Independence Baptist Church Founded", description: "A small group of Christians departed from the Lady's Island Baptist Church and organized the Independence Baptist Church on Coosaw Island, South Carolina. The island, only accessible by boat, was home to many faithful and dedicated Christians. Rev. Frank Barnwell was chosen as the first pastor.", order: 1 },
  { id: "tl2", year: 1879, title: "Renamed Samaritan Baptist Church", description: "The church name was changed from Independence Baptist to Samaritan Baptist Church. Rev. John Brown became pastor and ministered faithfully for thirty-five years, during which the church thrived and grew. Nine deacons were ordained during his tenure.", order: 2 },
  { id: "tl3", year: 1915, title: "A Season of Faithful Leadership", description: "Following Rev. Brown's retirement in 1914, many pastors were called to lead this dedicated group of Christians over the next several decades, including Rev. Jack Jones, Rev. Isaac Sumpter, Rev. Israel Brisbane, and Rev. John Hutto. During this period, a division led to the founding of the Anteza Baptist Church nearby.", order: 3 },
  { id: "tl4", year: 1961, title: "Two Churches Become One", description: "In March 1961, God spoke to the leaders of both the Samaritan and Anteza Baptist churches and reminded them of the true purpose of the Church. The two congregations reunited to form the Friendship Baptist Church — 'The Church that Christ Built.' Rev. Jacob Hamilton became pastor and Deacon Dan Jones was selected as Chairman.", order: 4 },
  { id: "tl5", year: 1980, title: "Rev. Irvin Middleton Called to Serve", description: "God sent Friendship a humble servant in Rev. Irvin Middleton. For thirty years, Rev. Middleton groomed, trained, and ordained several ministers and many deacons, faithfully shepherding the congregation until his retirement in May 2011.", order: 5 },
  { id: "tl6", year: 2005, title: "Historic Sanctuary Renovation", description: "Under the project management of then-Deacon Isiah Smalls as Assistant Chairman of the Trustee Board, Friendship completed the most extensive renovation in the church's history — a $375,000 remodeling of the entire sanctuary and the addition of 1,700 square feet of classroom and office space.", order: 6 },
  { id: "tl7", year: 2011, title: "Pastor Isiah Smalls Installed", description: "On October 10, 2011, Friendship Baptist Church selected Minister Isiah Smalls as their pastor, with formal installation services held November 20, 2011. Pastor Smalls brought renewed vision, vigor, and a deep commitment to Word-based worship to the congregation.", order: 7 },
  { id: "tl8", year: 2014, title: "Mortgage Burning Celebration", description: "Through a God-inspired fundraising campaign initiated by Pastor Smalls in 2012, and with the faithful support of willing parishioners, the church mortgage was paid off in its entirety — ahead of schedule. A Mortgage Burning Ceremony was celebrated in November 2014 to commemorate this great accomplishment.", order: 8 },
  { id: "tl9", year: 2020, title: "The Parking Lot Services", description: "During the Covid-19 pandemic, Pastor Smalls spearheaded an innovative 'Parking Lot Service' using an outdoor sound system and small radio transmitter. The Word was delivered to members in their cars and community members listening from their porches. For over 15 months under the beautiful live oaks, Friendship never missed a beat in Christian fellowship — without a single incident of Covid-19 infection.", order: 9 },
  { id: "tl10", year: 2025, title: "Continued Growth & God's Blessings", description: "Friendship expanded its fellowship hall by nearly 1,000 sq ft, modernized the kitchen and dining area — a $270,000 project completed debt-free. Through the generosity of the Battey Family Partnership, five acres of adjacent land were gifted to the church in memory of Bro. Peter Brown and Mother Ethel Grant, doubling the property to 10 acres. To God Be the Glory!", order: 10 },
];
